...
import IHM.domain.SimpleTirage;
...
public class WelcomeJFrame extends JFrame {
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon(
				"C:\\Users\\TAGNATI\\Downloads\\GLPOO-master\\GLPOO-master\\GLPOOproject\\src\\main\\ressources\\Accueil1.jfif"));
	...
	private class Jouer extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			case 2:
				...
				dispose();
				new TirageToFractale(newTirage);
				break;
			default:
				System.out.println("Pas encore développé !");
