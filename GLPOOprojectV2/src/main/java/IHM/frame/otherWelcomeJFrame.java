...
public class otherWelcomeJFrame extends JFrame {

	private JPanel contentPane;

	
	public otherWelcomeJFrame() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\TAGNATI\\Downloads\\GLPOO-master\\GLPOO-master\\GLPOOproject\\src\\main\\ressources\\Accueil1.jfif"));
		panel_1.add(label);
	}
