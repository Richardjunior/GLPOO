...
public class JuliaFrame extends JFrame {
	...
	//AFFICHAGE DE LA BOITE DE DIALOGUE : Indications touches
        ...
        JLabel label = new JLabel("<html> <center><p><h3> <strong>     KEYBOARD OPTIONS :   </strong>  </h3></p> "
        						      + "	<p>    - To use zoom function press + or -      </p>"
        						      + "	<p><br>    - To use translate function press <br>keyboard direction arrows       </center></p>"
        						      + "</html>");
        panel.add(label);
        JButton gotIt = new JButton(new OKAction());
        dialog.add(panel,BorderLayout.NORTH);
        dialog.add(gotIt,BorderLayout.SOUTH);
